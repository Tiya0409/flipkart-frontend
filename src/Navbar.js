    ...
    <nav className="w-full bg-white shadow-sm font-sans">
      <div className="flex items-center px-8 py-2 justify-between">
        ...
        <div className="flex items-center gap-6">
          <Link to="/cart" className="relative font-medium flex items-center">
          ...
          >
            <span className="flex items-center gap-1">
              ...
              <span className="text-blue-700">Tiya</span>
                    ...
                    <li key={idx}>
                      {item.route === "/logout" ? (
                        <button
                          ...
                          className="w-full text-left flex items-center gap-3 px-4 py-2 hover:bg-gray-100 text-gray-800 text-base"
                        >
                        ...
                        <Link
                          to={item.route}
                          className="flex items-center gap-3 px-4 py-2 hover:bg-gray-100 text-gray-800 text-base"
                        >
                          <span className="text-lg">{item.icon}</span>
                          <span>{item.label}</span>
                        </Link>
      ...
      <div className="flex justify-around items-end py-4 border-b border-gray-100 bg-white">
        {categories.map((cat) => (
          <Link
            to={cat.route}
            className="flex flex-col items-center min-w-[80px] transition-colors hover:text-blue-600"
            key={cat.name}
          >
